...
export const getMangaListService = async (): Promise<MangaInfo[]> => {
...
export const getMangaFromNameService = async (name: string): Promise<MangaInfo | null> => {
    const db = await getDb();
...
export const getMangaFromSiteService = async (site: string): Promise<MangaInfo | null> => {
    const db = await getDb();
...
export const addMangaService = async (manga: MangaInfo): Promise<void> => {
    const db = await getDb();
...
export const addSiteToMangaService = async (mangaName: string, site: SiteInfo): Promise<void> => {
    const db = await getDb();
...
export const updateMangaService = async (manga: MangaInfo): Promise<void> => {
    const db = await getDb();
...
export const deleteMangaService = async (name: string): Promise<void> => {
    const db = await getDb();
...
export const deleteSiteFromMangaService = async (mangaName: string, site: SiteInfo): Promise<void> => {
    const db = await getDb();
